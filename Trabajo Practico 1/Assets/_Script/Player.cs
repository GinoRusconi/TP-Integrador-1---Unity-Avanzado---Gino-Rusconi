...
public class Player : Entity
{
    ...
    protected override void Update()
    {
        ...
        if (isAlive && !m_animationFlag.throwGranade)
        {
            isThrow = false;
            ...
            transform.LookAt(inputHandler.targetPositionClick);
    ...
    private void FixedUpdate()
    {
        ...
        if (isAlive)
        {
            ...
            {
                transform.Translate(inputHandler.directionMove * Time.deltaTime * movementVelocity);
